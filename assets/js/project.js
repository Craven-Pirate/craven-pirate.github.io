...
const projects = [
  {
    title: "Bulk Mailing",
    cardImage: "assets/images/project-page/mailing.jpg",
    description: "Python code for mailing multiple recipients using GMail API at custom time.",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "https://github.com/Craven-Pirate/Mass_Mailing_using_GMail_API",
  },
  {
    title: "Website Dev",
    cardImage: "assets/images/project-page/website_1.png",
    description: "Custom Website to keep track of activities and act as an anchor point.",
    tagimg: "https://image.flaticon.com/icons/png/512/643/643350.png",
    Previewlink: "",
    Githublink: "https://github.com/Craven-Pirate/craven-pirate.github.io",
  },
  {
    title: "NSE Data Fetcher",
    cardImage: "assets/images/project-page/nse.png",
    description: "A private python based data scraper program to get data of everything present in NSE using multiple API calls.",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "",
  },
  {
    ...
    cardImage: "assets/images/project-page/codeforces.png",
    description: "A blog to write about my competitive programming journey of solving Codeforces and Leetcode.",
    tagimg: "https://miro.medium.com/max/2800/0*U2DmhXYumRyXH6X1.png",
    Previewlink: "",
    Githublink: "https://personalcfsolutions.wordpress.com/",
  },
];
...
/* Project Cards Following */

const projectcardsx = document.querySelector(".projectcardsx");
...
const showCardsx = () => {
  let output = "";
  projectsx.forEach(({ title, cardImage, Previewlink, Githublink }) => {
    output += `       
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
            <div class="header">
  ...
  projectcardsx.innerHTML = output;
};
document.addEventListener("DOMContentLoaded", showCardsx);
